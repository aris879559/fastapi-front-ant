...
export async function userList(params: USER.GetUserListQuery) {
  return request<USER.ResGetUserList>('/api/v1/admin/user/user_list', {
    method: 'GET',
    params,
  });
}
...
export async function userAdd(body: USER.CreateUser) {
  return request<APIBASE.BASE>('/api/v1/admin/user/user_add', {
    method: 'POST',
    data: body,
  });
}
...
export async function userUpdate(body: USER.UpdateUser) {
  return request<APIBASE.BASE>('/api/v1/admin/user/user_update', {
    method: 'PUT',
    data: body,
  });
}
...
export async function userDelete(params: { user_id: number }) {
  return request<APIBASE.BASE>('/api/v1/admin/user/user_del', {
    method: 'DELETE',
    params,
  });
}
